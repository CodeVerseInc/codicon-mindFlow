...
function SignIn() {
	return (
		<section className='flex justify-center items-center [grid-area:main] md:mt-4'>
			<div className='bg-white p-5 2xl:p-10 flex flex-col-reverse md:flex-row  md:gap-5 md: justify-center 2xl:justify-between md:items-center sm:w-[900px] 2xl:w-[1200px]  rounded-lg dark:bg-bg-dark dark:text-white'>
				<article className='rounded-lg w-full md:w-[480px] '>
					...
					<div className='text-center md:mt-5 2xl:mt-10'>
						<Link href='login'>
							Ya tienes cuenta?{' '}
							<span className='text-tom-thumb-500 font-semibold '>
								Iniciar sesión
							</span>
						</Link>
					</div>
				...
				<article>
					<picture className='text-center'>
						<img
							...
							className='rounded-lg 2xl:w-[480px] 2xl:h-[480px]'
							width={300}
							height={520}
						/>
					</picture>
